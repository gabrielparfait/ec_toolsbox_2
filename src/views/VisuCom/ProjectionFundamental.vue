<template>
  <div>
    ...
    <strong>
      <a
        href="https://fac.umc.edu.dz/fll/images/cours-fran%C3%A7ais/M1/Didactique/M1%20TICE.pdf"
        target="_blank"
        class="subtitle-link"
        >Réaliser ses supports de présentation sur PowerPoint
        <b-icon icon="box-arrow-right"></b-icon
      ></a>
    </strong>
    <p><i>Source</i> : UFMC 1</p>
    <strong>
      <a
        href="https://www.canva.com/fr_fr/decouvrir/tuto-diaporama-presentation/"
        target="_blank"
        class="subtitle-link"
        >Les clés d’un diaporama réussi <b-icon icon="box-arrow-right"></b-icon
      ></a>
    </strong>
    <p><i>Source</i> : Canva</p>
    <h4>Les règles d'or du diaporama</h4>
    <strong>
      <a
        href="/pdf_projection/HowTo.pdf"
        class="subtitle-link"
    ...
    >
      <p class="text-vid">
        ...
        immac-pau.net <b-icon icon="box-arrow-right" />
      </p>
    </a>
